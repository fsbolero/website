...
> The difference between the two is based on a simple heurisitic: if the string contains the character `'<'`, it is read as plain HTML, otherwise it is read as a file path.
